...
export default function BackOfficePath() { 
    ...
    const fillColor0 = main.svgFillColor0;
    ...
    return <div className='w-full h-[200px] scrollbar-thin scrollbar-thumb-white scrollbar-track-transparent overflow-x-hidden hover:overflow-x-auto'>
        ...
        {restaurantSettings.main.svgL === SVGTypesSettingsEnum.CIRCLE &&
            <circle fill={fillColor0} strokeOpacity={0} fillOpacity={1} cx="104.42" cy="150.37" r="102.7" />}
        {restaurantSettings.main.svgL === SVGTypesSettingsEnum.STAR &&
        ...
        {restaurantSettings.main.svgL === SVGTypesSettingsEnum.STAR_8 &&
        ...
        <text fill={fillColor1} strokeOpacity={0} fillOpacity={1} textAnchor="middle"
            fontSize={switchToFontSize(restaurantSettings.main.fontSize).fontSize2} fontWeight="bold"
            dominantBaseline="middle" transform="translate(105 158)">{ restaurantSettings.main.startText}</text>
        
        {restaurantSettings.main.svgS === SVGTypesSettingsEnum.CIRCLE &&
            <circle fill={fillColor1} strokeOpacity={0} fillOpacity={1} cx="601.07" cy="381.54" r="70.72" />
        }
        { restaurantSettings.main.svgS === SVGTypesSettingsEnum.STAR_8 &&
        ...
        {restaurantSettings.main.svgS === SVGTypesSettingsEnum.STAR &&
