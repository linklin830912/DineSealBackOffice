...
export default function BackOfficePath() { 
    ...
    return <svg viewBox="0 0 1200 454.47" height={"100%"} transform="translate(50 0)" fill="none" strokeLinecap="round" stroke={strokeColor1} >
        ...
        {restaurantSettings.theme.svgL === SVGTypesSettingsEnum.STAR &&
        ...
        { restaurantSettings.theme.svgS === SVGTypesSettingsEnum.STAR_8 &&
        ...
        {restaurantSettings.theme.svgS === SVGTypesSettingsEnum.STAR &&
